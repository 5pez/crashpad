    ...
    <div class="container mx-auto px-4 md:px-12">
      <section class="py-8 px-4">
        ...
        <div class="flex justify-between pb-4">
          ...
          <span class="flex space font-semibold hover:text-yellow-500">
        ...
        <div class="flex justify-between px-4">
          ...
          <span class="border-2 border-gray-200 rounded shadow-lg p-4">
            ...
            <button class="inline-block bg-yellow-500 rounded px-24 py-4 text-lg font-semibold text-white mr-1">
              Reserve
            </button>
          </span>
        </div>
