export default function Privacy() {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Crashpad.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Crashpad, accessible from
            <a
              href="https://www.crashpad.dev"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.crashpad.dev
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: elam.j.aaron@gmail.com</li>
      </ul>
    </>
  );
}
